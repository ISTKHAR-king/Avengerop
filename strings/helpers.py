...
HELP_9 = """
<u><b>ᴍᴜsɪᴄᴀʟ sᴛᴀᴛs</b></u>:
/profile : ᴄᴏᴍᴍᴀɴᴅ ᴛᴏ ᴠɪᴇᴡ ʏᴏᴜʀ ᴘᴇʀsᴏɴᴀʟ ɪɴғᴏ 📊. 
/leaderboard : ᴄᴏᴍᴍᴀɴᴅ ᴛᴏ sᴇᴇ ᴛʜᴇ ᴛᴏᴘ-ʀᴀɴᴋɪɴɢ ɢʀᴏᴜᴘs ʙᴀsᴇᴅ ᴏɴ ᴛʜᴇɪʀ ᴏᴠᴇʀᴀʟʟ ᴍᴜsɪᴄᴀʟ ᴀᴄᴛɪᴠɪᴛʏ! 🏆
"""
